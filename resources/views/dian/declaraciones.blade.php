        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-3">
                            <a href="{{ route('reports.payroll.pdf') }}" target="_blank" class="btn btn-dark w-100 mb-2">
                                <i class="fas fa-file-pdf me-2"></i>
                                Reporte Nómina
                            </a>
                        </div>
                        <div class="col-md-3">
                            <a href="{{ route('dian.retenciones') }}" class="btn btn-dark w-100 mb-2">
                                <i class="fas fa-receipt me-2"></i>
                                Ver Retenciones
                            </a>
                        </div>
                        <div class="col-md-3">
                            <a href="{{ route('dian.certificacion') }}" class="btn btn-dark w-100 mb-2">
                                <i class="fas fa-certificate me-2"></i>
                                Generar Certificados
                            </a>
                        </div>
                        <div class="col-md-3">
                            <a href="{{ route('dian.aportes') }}" class="btn btn-dark w-100 mb-2">
