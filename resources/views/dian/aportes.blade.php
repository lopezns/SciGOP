    ...
    <div class="bg-white rounded-xl shadow-sm border border-amber-200 overflow-hidden">
        ...
        <div class="p-6">
            <div class="flex justify-center">
                <button onclick="exportToExcel()" class="bg-amber-600 hover:bg-amber-700 text-white px-8 py-3 rounded-lg text-center font-semibold flex items-center space-x-2">
                    <span>📋</span>
